...
def get_df():
    url_cost = "https://raw.githubusercontent.com/gjuresic/cost_of_living_german_cities/main/src/data/cost_of_living_data.csv"
    url_geo = "https://raw.githubusercontent.com/gjuresic/cost_of_living_german_cities/main/src/data/geo_data.csv"
    df = pd.read_csv(url_cost)
