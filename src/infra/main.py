...
def main():
    ...
    df_cost_of_living.to_csv('/Users/gjuresic/Desktop/python_projects/cost_of_living_german_cities/src/'
                             'data/cost_of_living_data.csv')

    df_geo_data = get_lat_lon_for_cities()
    df_geo_data.to_csv('/Users/gjuresic/Desktop/python_projects/cost_of_living_german_cities/src/data/geo_data.csv')
